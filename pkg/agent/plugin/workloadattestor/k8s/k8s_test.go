...
`))
	...
	testPodSelectors = []*common.Selector{
		...
		{Type: "k8s", Value: "pod-container-count:2"},
		{Type: "k8s", Value: "pod-image:docker-pullable://localhost/spiffe/blog@sha256:0cfdaced91cb46dd7af48309799a3c351e4ca2d5e1ee9737ca0cbd932cb79898:count=1"},
		{Type: "k8s", Value: "pod-image:docker-pullable://localhost/spiffe/ghostunnel@sha256:b2fc20676c92a433b9a91f3f4535faddec0c2c3613849ac12f02c1d5cfcd4c3a:count=1"},
		{Type: "k8s", Value: "pod-init-container-count:0"},
	...
	testKindPodSelectors = []*common.Selector{
		...
		{Type: "k8s", Value: "ns:default"},
		{Type: "k8s", Value: "pod-container-count:1"},
		{Type: "k8s", Value: "pod-image:gcr.io/spiffe-io/spire-agent@sha256:1e4c481d76e9ecbd3d8684891e0e46aa021a30920ca04936e1fdcc552747d941:count=1"},
		{Type: "k8s", Value: "pod-init-container-count:0"},
	...
	testInitPodSelectors = []*common.Selector{
		...
		{Type: "k8s", Value: "pod-container-count:1"},
		{Type: "k8s", Value: "pod-image:docker-pullable://quay.io/coreos/flannel@sha256:1b401bf0c30bada9a539389c3be652b58fe38463361edf488e6543c8761d4970:count=1"},
		{Type: "k8s", Value: "pod-init-container-count:1"},
		{Type: "k8s", Value: "pod-init-image:docker-pullable://quay.io/coreos/flannel@sha256:1b401bf0c30bada9a539389c3be652b58fe38463361edf488e6543c8761d4970:count=1"},
