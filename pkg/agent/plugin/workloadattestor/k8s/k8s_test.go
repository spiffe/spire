...
`))
	...
	testPodSelectors = []*common.Selector{
		...
		{Type: "k8s", Value: "pod-images:d9ba03bc169066b5d3a8e3bb2f63d5806f911db4cdc4132a4b37e24720b0d3cd"},
	...
	testKindPodSelectors = []*common.Selector{
		...
		{Type: "k8s", Value: "ns:default"},
		{Type: "k8s", Value: "pod-images:cb32e692f09ff630c71e43d26bdcf2f0e5eeb7b1f4657d01831007f0aaa34bbc"},
		{Type: "k8s", Value: "pod-init-images:"},
	...
	testInitPodSelectors = []*common.Selector{
		...
		{Type: "k8s", Value: "pod-images:87a69ab8c4ae238b659477e1debfb5b8a3f9d77c909a9985fb0ae1f00b24a413"},
		{Type: "k8s", Value: "pod-init-images:87a69ab8c4ae238b659477e1debfb5b8a3f9d77c909a9985fb0ae1f00b24a413"},
