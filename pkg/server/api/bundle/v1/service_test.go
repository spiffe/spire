			...
			expectLogs: []spiretest.LogEntry{
				{
					...
					Data: logrus.Fields{
						...
						"jwt_authority_public_key.0": pkixBytesHashed,
						"x509_authorities_asn1.0":    x509CertHashed,
					},
				},
			},
		},
			...
			expectLogs: []spiretest.LogEntry{
				...
				},
				{
					...
					Data: logrus.Fields{
						...
						"x509_authorities_asn1.0": api.HashByte([]byte("malformed")),
					},
				},
			},
		},
			...
			expectLogs: []spiretest.LogEntry{
				...
				},
				{
					...
					Data: logrus.Fields{
						...
						"jwt_authority_public_key.0": api.HashByte([]byte("malformed")),
					},
				},
			},
		},
			...
			expectLogs: []spiretest.LogEntry{
				{
					...
					Data: logrus.Fields{
						...
						telemetry.JWTAuthorityPublicKey: pkixHashed,
			...
			expectLogs: []spiretest.LogEntry{
				...
				},
				{
					...
					Data: logrus.Fields{
						...
						telemetry.Type:                  "audit",
						telemetry.JWTAuthorityKeyID:     "key1",
						telemetry.JWTAuthorityPublicKey: api.HashByte([]byte("malformed key")),
						telemetry.JWTAuthorityExpiresAt: expiresAtStr,
					},
				},
			},
			...
			expectedLogMsgs: []spiretest.LogEntry{
				...
				},
				{
					...
					Data: logrus.Fields{
						...
						telemetry.TrustDomainID:   "another-example.org",
						"x509_authorities_asn1.0": x509BundleHash,
					},
				},
			},
		},
