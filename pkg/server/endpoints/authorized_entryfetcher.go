...
func (a *AuthorizedEntryFetcherWithEventsBasedCache) FindAuthorizedEntries(ctx context.Context, agentID spiffeid.ID, entryIDs map[string]struct{}) (map[string]*types.Entry, error) {
	return a.cache.FindAuthorizedEntries(agentID, entryIDs), nil
}
