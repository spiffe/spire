...
func TestWrapWithDeprecationLogging(t *testing.T) {
	...
	streamServerInfo := &grpc.StreamServerInfo{FullMethod: fullMethod}
	unaryServerInfo := &grpc.UnaryServerInfo{FullMethod: fullMethod}
