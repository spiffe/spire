...
// AWS RSA-2048 public CA certificates in PEM format, used to verify instance identity documents.
const (
	// US East (N. Virginia) Region (us-east-1)
	// Expires in Jan 17, 2195
...
-----END CERTIFICATE-----`
	...
	// Asia Pacific (Sidney) Region (ap-southeast-2)
	// Expires in Apr 3, 2195
...
-----END CERTIFICATE-----`
	...
	// Expires in May 8, 2195
	cnNorthWest1Cert = `-----BEGIN CERTIFICATE-----
...
var awsCACerts = map[string]string{
...
func getAWSCACertificate(region string) (*x509.Certificate, error) {
	cert, ok := awsCACerts[region]
	if !ok {
