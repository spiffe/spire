...
func (w datastoreWrapper) RevokeX509CA(ctx context.Context, trustDomainID string, authorityID string) error {
	err := w.DataStore.RevokeX509CA(ctx, trustDomainID, authorityID)
	if err == nil {
		w.bundleUpdated()
	}
	return err
