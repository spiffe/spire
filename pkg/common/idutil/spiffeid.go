...
// TrustDomainID creates an trust domain SPIFFE ID given a trust domain. If the passed
...
// TrustDomainURI creates an trust domain SPIFFE URI given a trust domain or trust domain ID.
