...
type ValidaterFunc func(ctx context.Context, coreConfig CoreConfig, configuration string) error
...
func (fn ValidaterFunc) Validate(ctx context.Context, coreConfig CoreConfig, configuration string) error {
	return fn(ctx, coreConfig, configuration)
}
