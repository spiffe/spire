...
// Source: github.com/spiffe/spire/proto/server/noderesolver (interfaces: NodeResolver,NodeResolverClient,NodeResolverServer,Plugin)
...
// Resolve mocks base method
func (m *MockPlugin) Resolve(arg0 context.Context, arg1 *noderesolver.ResolveRequest) (*noderesolver.ResolveResponse, error) {
	ret := m.ctrl.Call(m, "Resolve", arg0, arg1)
	ret0, _ := ret[0].(*noderesolver.ResolveResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// Resolve indicates an expected call of Resolve
func (mr *MockPluginMockRecorder) Resolve(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Resolve", reflect.TypeOf((*MockPlugin)(nil).Resolve), arg0, arg1)
}
