...
func (m *MockServerCa) Configure(arg0 *plugin.ConfigureRequest) (*plugin.ConfigureResponse, error) {
...
func (mr *MockServerCaMockRecorder) Configure(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Configure", reflect.TypeOf((*MockServerCa)(nil).Configure), arg0)
}

// FetchCertificate mocks base method
func (m *MockServerCa) FetchCertificate(arg0 *ca.FetchCertificateRequest) (*ca.FetchCertificateResponse, error) {
...
func (mr *MockServerCaMockRecorder) FetchCertificate(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchCertificate", reflect.TypeOf((*MockServerCa)(nil).FetchCertificate), arg0)
}
