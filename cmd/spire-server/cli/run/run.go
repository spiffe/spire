...
func parseFlags(name string, args []string, output io.Writer) (*serverConfig, error) {
	...
	common_cli.StringVar(flags, &c.ConfigPath, "config", "c", "", "Path to a SPIRE config file")
	common_cli.StringVar(flags, &c.DataDir, "dataDir", "d", "", "Directory to store runtime data to")
