...
func (p ControlPlaneCaPlugin) GRPCServer(s *grpc.Server) error {
	sri_proto.RegisterControlPlaneCAServer(s, &GRPCServer{ControlPlaneCaImpl: p.ControlPlaneCaImpl})
	return nil
}

func (p ControlPlaneCaPlugin) GRPCClient(c *grpc.ClientConn) (interface{}, error) {
	return &GRPCClient{client: sri_proto.NewControlPlaneCAClient(c)}, nil
}
