...
* [node.proto](#node.proto)
    ...
    * [FetchCPBundleRequest](#pb.FetchCPBundleRequest)
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| attestedData | [AttestedData](#pb.AttestedData) |  | A type which contains attestation data for specific platform. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| spiffeEntry | [SvidUpdate](#pb.SvidUpdate) |  | It includes a map of signed SVIDs and an array of all current Registration Entries which are relevant to the caller SPIFFE ID. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| svidMap | [SvidMap](#pb.SvidMap) |  | A map containing SVID values and corresponding SPIFFE IDs as the keys. |
...
| ----------- | ------------ | ------------- | ------------|
| FetchBaseSVID | [FetchBaseSVIDRequest](#pb.FetchBaseSVIDRequest) | [FetchBaseSVIDResponse](#pb.FetchBaseSVIDRequest) | Attest the node, get base node SVID. |
| FetchSVID | [FetchSVIDRequest](#pb.FetchSVIDRequest) | [FetchSVIDResponse](#pb.FetchSVIDRequest) | Get Workload, Node Agent certs and CA trust bundles. Also used for rotation(Base Node SVID or the Registered Node SVID used for this call)(List can be empty to allow Node Agent cache refresh). |
| FetchCPBundle | [FetchCPBundleRequest](#pb.FetchCPBundleRequest) | [FetchCPBundleResponse](#pb.FetchCPBundleRequest) | Called by Node Agent periodically to support Control Plane certificate rotation. Cached in Node Agent memory for WorkLoads as well. |
| FetchFederatedBundle | [FetchFederatedBundleRequest](#pb.FetchFederatedBundleRequest) | [FetchFederatedBundleResponse](#pb.FetchFederatedBundleRequest) | Called by the Node Agent to fetch the named Federated CA Bundle.Used in the event that authorized workloads reference a Federated Bundle. |
