...
To test auto-generation of SPIFFE IDs add the following label to a Pod Spec and the apply it. Ther format for the auto-generated SPIFFE ID in this example is `ns/<namespace>/pod/<pod-name>`.
