...
| `-config (-c)`                        | Path to a SPIRE config file                                                         | conf/agent/agent.conf |
| `-dataDir (-d)`                       | A directory the agent can use for its runtime data                                  |                       |
...
| `-socketPath (-s)`                    | Location to bind the workload API socket                                            |                       |
