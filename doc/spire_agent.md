...
| `sds_default_tls_certificate_name`    | SDS default TLS certificate resource name                             |                      |
| `sds_default_validation_context_name` | SDS default validation context resource name                          |                      |
