...
| SVIDStore        | [gcloud_secretmanager](doc/plugin_agent_svidstore_gcloud_secretmanager.md) | An SVIDStore which stores secrets in the GCloud secret manager with the resulting X509-SVIDs of the entries that the agent is entitled to. |
