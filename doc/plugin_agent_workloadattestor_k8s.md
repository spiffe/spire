...
| `enable_namespace_labels`               | If true, namespace labels are fetched from the Kubernetes API server and produced as selectors. Requires RBAC `get` on `namespaces`. Disabled by default.                                                                               |
