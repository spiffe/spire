...
> [!WARNING]
> AWS Roles Anywhere only allows configuring up to two CAs per trust anchor. If you are using this plugin, you will need
...
> Also have in mind that expire CAs are only removed from the bundle 24 hours after expiry.
