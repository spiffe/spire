...
| KeyManager  | [awskms](/doc/plugin_server_keymanager_awskms.md) | A key manager for signing SVIDs which only stores keys in AWS KMS and does not actually persist them anywhere |
