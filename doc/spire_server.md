...
| UpstreamAuthority  | [cmp](/doc/plugin_server_upstreamauthority_cmp.md)                                                   | CMP-based upstream authority that submits SPIRE CSRs to an upstream CA and returns the issued certificate.                  |
