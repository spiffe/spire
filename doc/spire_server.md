...
| UpstreamAuthority  | [kmip](/doc/plugin_server_upstreamauthority_kmip.md)                                                 | Uses a CA stored in a KMIP-compliant server to sign SPIRE server intermediate certificates.                                                                         |
