...
| UpstreamCA | [spire](/doc/plugin_server_upstreamca_spire.md) | Uses a CA loaded from upstream SPIRE server in the same trust domain to sign SPIRE server intermediate certificates. |
