...
| `bundle_cache_ttl`            | How long federated bundle reads are cached before being refreshed from the database. Enabling this will mitigate high database load for deployments with many federations, but will also slow propagation of federated bundle updates to agents.                                                                                                          | disabled                           |
