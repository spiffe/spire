...
| `policy_engine`             | The policy engine used to determine authorization decision                                        | default SPIRE authorization policy                             |
...
| policy_engine               | Description                    | Default        |
|:----------------------------|--------------------------------|----------------|
| `file_provider`             | File to retrieve OPA rego policy for authorization. |      |

| policy_engine.file_provider | Description                    | Default        |
|:----------------------------|--------------------------------|----------------|
| `policy_path`               | File to retrieve OPA rego policy for authorization. |      |
| `permissions_path`          | File to retrieve databindings for policy evaluation, defining permissions and rules for use in the rego policy. |      |
