...
| `graceful_stop_wait`                | Configure the time to wait for downstream clients to disconnect from the SPIRE server when it is shutting down. After the duration is exceeded, the SPIRE server will close its connections.                                                    | 30s                                                            |
