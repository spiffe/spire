...
golangci_lint_version := $(shell awk '/golangci_lint/{print $$2}' .project-versions)
golangci_lint_dir = $(build_dir)/golangci_lint/$(golangci_lint_version)
golangci_lint_bin = $(golangci_lint_dir)/golangci-lint
golangci_lint_cache = $(golangci_lint_dir)/cache

markdown_lint_version := $(shell awk '/markdown_lint/{print $$2}' .project-versions)
markdown_lint_image = ghcr.io/igorshubovych/markdownlint-cli:$(markdown_lint_version)

protoc_version := $(shell awk '/protoc/{print $$2}' .project-versions)
ifeq ($(os1),windows)
