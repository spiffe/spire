...
- The `k8s` and `docker` workload attestors new ignore cgroup mountinfo with root == / (#6462)
- spire-server now stops fetch all events if a context cancelled error is returning while processing a list of events (#6472)
