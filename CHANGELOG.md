...
- The `k8s_bundle` notifier plugin can now keep API service CA bundles up to date
...
- The `k8s-workload-registrar` now uses paging to support very large deployments of 10,000+ pods

### Fixed
- Fixed a bug that sometimes caused new agents to not receive their full set of selectors (#2242)
