...
- Added registration entry revision number functionality (#1720)
- Fixed to have `/tmp/agent.sock` as the default socket path in the agent when it is not configured (#1738)
