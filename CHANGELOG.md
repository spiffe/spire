...
### Added
- SPIRE images are now published to GitHub Container Registry. They will continue to be published to Google Container Registry for the next release (#2576,#2580)
- SPIRE Server now implements the TrustDomain API, which allows callers to manage dynamic federation relationships (#2497,#2524,#2532,#2533,#2535,#2536,#2541,#2544,#2545,#2546,#2547,#2549,#2550,#2557,#2559,#2560,#2561,#2562,#2563,#2564,#2565,#2566,#2568,#2571,#2572,#2574,#2575).
...
- A built-in AWS Secrets Manager SVIDStore plugin has been introduced, which can push workload SVIDs into AWS secrets (#2542)
...
- Self-signed CA certificates now have a random serial number (#2494)
- The AWS KMS Key Manager plugin now creates keys with a very strict policy by default (#2424)
- SPIRE Server CLI commands now page results from the API (#2456)
...
- Legacy (v0) plugin support has been removed. All plugins must now be authored using the plugin SDK. (#2488,#2490,#2516,#2517,#2518,#2520,#2521,#2522,#2523,#2525,#2528)
