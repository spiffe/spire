...
func (m *NoStreamRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NoStreamRequest.Merge(m, src)
}
...
func (*NoStreamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f61c4c74b7db52b0, []int{1}
}
...
func (m *NoStreamResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NoStreamResponse.Merge(m, src)
}
...
func (*ClientStreamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f61c4c74b7db52b0, []int{2}
}
...
func (*ClientStreamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f61c4c74b7db52b0, []int{3}
}
...
func (*ServerStreamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f61c4c74b7db52b0, []int{4}
}
...
func (*ServerStreamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f61c4c74b7db52b0, []int{5}
}
...
func (*BothStreamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f61c4c74b7db52b0, []int{6}
}
...
func (m *BothStreamRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BothStreamRequest.Merge(m, src)
}
...
func (*BothStreamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f61c4c74b7db52b0, []int{7}
}
...
func (m *BothStreamResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BothStreamResponse.Merge(m, src)
}
