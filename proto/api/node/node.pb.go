...
func (*Bundle) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{0}
}
...
func (*X509SVID) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{1}
}
...
type X509SVIDUpdate struct {
	...
	Bundles              map[string]*Bundle `protobuf:"bytes,4,rep,name=bundles,proto3" json:"bundles,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (*X509SVIDUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{2}
}
...
func (*JSR) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{3}
}
...
func (*JWTSVID) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{4}
}
...
func (*AttestRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{5}
}
...
func (*AttestResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{6}
}
...
func (*FetchX509SVIDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{7}
}
...
func (*FetchX509SVIDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{8}
}
...
func (*FetchJWTSVIDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{9}
}
...
type FetchJWTSVIDResponse struct {
	...
	// Trust bundles associated with the SVID, keyed by trust domain SPIFFE
	// ID. Bundles included are the trust bundle for the server trust domain
	// and any federated trust domain bundles applicable to the SVID.
	Bundles              map[string]*Bundle `protobuf:"bytes,2,rep,name=bundles,proto3" json:"bundles,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (*FetchJWTSVIDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_2016e66bdd7f3eaa, []int{10}
}
...
func (m *FetchJWTSVIDResponse) GetBundles() map[string]*Bundle {
	if m != nil {
		return m.Bundles
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*Bundle)(nil), "spire.api.node.FetchJWTSVIDResponse.BundlesEntry")
}
...
func init() { proto.RegisterFile("node.proto", fileDescriptor_node_2016e66bdd7f3eaa) }

var fileDescriptor_node_2016e66bdd7f3eaa = []byte{
	// 707 bytes of a gzipped FileDescriptorProto
	,
}
