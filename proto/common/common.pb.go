...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_bedeba806389b6b9, []int{0}
}
...
func (*AttestedData) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_bedeba806389b6b9, []int{1}
}
func (m *AttestedData) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AttestedData.Unmarshal(m, b)
}
func (m *AttestedData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AttestedData.Marshal(b, m, deterministic)
}
func (dst *AttestedData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AttestedData.Merge(dst, src)
}
func (m *AttestedData) XXX_Size() int {
	return xxx_messageInfo_AttestedData.Size(m)
}
func (m *AttestedData) XXX_DiscardUnknown() {
	xxx_messageInfo_AttestedData.DiscardUnknown(m)
}

var xxx_messageInfo_AttestedData proto.InternalMessageInfo
...
func (*Selector) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_bedeba806389b6b9, []int{2}
}
...
func (*Selectors) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_bedeba806389b6b9, []int{3}
}
...
func (*RegistrationEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_bedeba806389b6b9, []int{4}
}
...
func (*RegistrationEntries) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_bedeba806389b6b9, []int{5}
}
...
func init() { proto.RegisterFile("common.proto", fileDescriptor_common_bedeba806389b6b9) }

var fileDescriptor_common_bedeba806389b6b9 = []byte{
