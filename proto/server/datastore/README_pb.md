...
| ListMatchingEntries | [ListSelectorEntriesRequest](#spire.server.datastore.ListSelectorEntriesRequest) | [ListSelectorEntriesResponse](#spire.server.datastore.ListSelectorEntriesRequest) | Retrieves all the registered entry matching exactly any of the compound Selector from the generated power setof the input selector set |
