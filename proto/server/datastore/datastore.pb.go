...
type DataStoreClient interface {
	...
	// Retrieves all the  registered entry matching exactlly any of the compound Selector from the generated power set
	// of the input selector set
	ListPowerSelectorEntries(ctx context.Context, in *ListSelectorEntriesRequest, opts ...grpc.CallOption) (*ListSelectorEntriesResponse, error)
...
func (c *dataStoreClient) ListPowerSelectorEntries(ctx context.Context, in *ListSelectorEntriesRequest, opts ...grpc.CallOption) (*ListSelectorEntriesResponse, error) {
	out := new(ListSelectorEntriesResponse)
	err := grpc.Invoke(ctx, "/spire.server.datastore.DataStore/ListPowerSelectorEntries", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataStoreServer interface {
	...
	// Retrieves all the  registered entry matching exactlly any of the compound Selector from the generated power set
	// of the input selector set
	ListPowerSelectorEntries(context.Context, *ListSelectorEntriesRequest) (*ListSelectorEntriesResponse, error)
	// Retrieves all the  registered entry with the same SpiffeId
...
func _DataStore_ListPowerSelectorEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListSelectorEntriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataStoreServer).ListPowerSelectorEntries(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spire.server.datastore.DataStore/ListPowerSelectorEntries",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataStoreServer).ListPowerSelectorEntries(ctx, req.(*ListSelectorEntriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DataStore_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListPowerSelectorEntries",
			Handler:    _DataStore_ListPowerSelectorEntries_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
