...
type X509SVIDUpdate struct {
	...
	// keys. Map[SPIFFE_ID] => SVID. Used for responses to legacy agents.
	DEPRECATEDSvids map[string]*X509SVID `protobuf:"bytes,1,rep,name=DEPRECATED_svids,json=DEPRECATEDSvids,proto3" json:"DEPRECATED_svids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	Svids map[string]*X509SVID `protobuf:"bytes,2,rep,name=svids,proto3" json:"svids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *X509SVIDUpdate) GetDEPRECATEDSvids() map[string]*X509SVID {
	if m != nil {
		return m.DEPRECATEDSvids
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]*X509SVID)(nil), "spire.api.node.X509SVIDUpdate.DEPRECATEDSvidsEntry")
...
var fileDescriptor_0c843d59d2d938e7 = []byte{
	...
	,
}
