...
| ---- | ------ | ----------- |
| UNKNOWN | 0 | Unknown type of RegistrationEntry. Used for backward compatibility for registrations which did not set the type. |
| NODE | 1 | Node registration |
| WORKLOAD | 2 | Workload registration |
