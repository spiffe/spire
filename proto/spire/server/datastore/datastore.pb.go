...
type UpdateAttestedNodeRequest struct {
	...
	PreparedCertSerialNumber string   `protobuf:"bytes,4,opt,name=prepared_cert_serial_number,json=preparedCertSerialNumber,proto3" json:"prepared_cert_serial_number,omitempty"`
	PreparedCertNotAfter     int64    `protobuf:"varint,5,opt,name=prepared_cert_not_after,json=preparedCertNotAfter,proto3" json:"prepared_cert_not_after,omitempty"`
	XXX_NoUnkeyedLiteral     struct{} `json:"-"`
	XXX_unrecognized         []byte   `json:"-"`
	XXX_sizecache            int32    `json:"-"`
}
...
func (m *UpdateAttestedNodeRequest) GetPreparedCertSerialNumber() string {
	if m != nil {
...
func (m *UpdateAttestedNodeRequest) GetPreparedCertNotAfter() int64 {
	if m != nil {
...
var fileDescriptor_d08157cfd31fc929 = []byte{
	...
	,
}
